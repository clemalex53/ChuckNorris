...
object JokeList{
    val jokesString:List<String> = listOf(
        ...
        "Chuck Norris doesant need a miracle for the ocean to split he just walks in and the ocean gets the fuck out of the way",
        ...
        "Chuck Norris knows how many roundhouse kicks to your asshole that it takes to create your personal hemorrhoid bouquet.",
